...
import { Box, Flex, Text, Stack, Checkbox, Divider } from '@chakra-ui/react'
    ...
    <Box className="hideScroll" maxH={'calc(100vh - 100px)'} overflowY="scroll">
      ...
      {!isInitResultPresent() ? (
        ...
        <ButtonComp
          ...
          background={'rgba(var(--color-primary))'}
          color={'rgba(var(--text-color))'}
          handleOnClick={() => router.push(`/paymentMode?lang=${query?.lang}`)}
          isDisabled={false}
        />
      )}
    </Box>
